...
namespace DAL.Test
{
    public class DbConfiguratonTest
    {
        ...
        [Theory]
        [InlineData("server=localhost; user id=Tom; password=nde17065; port=3306;database=shopping;SslMode=None")]
        ...
        [Theory]
        [InlineData("server=localhost1;user id=Tom;password=nde17065;port=3306;database=shopping;SslMode=None")]
